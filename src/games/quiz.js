...
,
{zh:{q:'光的传播速度约为？',a:'3×10⁸ m/s',o:['3×10⁸ m/s','3×10⁶ m/s','3×10¹⁰ m/s','3×10⁴ m/s']},en:{q:'What is the speed of light?',a:'3×10⁸ m/s',o:['3×10⁸ m/s','3×10⁶ m/s','3×10¹⁰ m/s','3×10⁴ m/s']},idx:7},
{zh:{q:'元素周期表中有多少种元素？',a:'118',o:['118','108','128','98']},en:{q:'How many elements in the periodic table?',a:'118',o:['118','108','128','98']},idx:8},
]
const games = new Map();
...
module.exports = {
  ...
  async handleCallback(ctx, action) {
    if(action.startsWith('ans_')){
      ...
      if(g.total>=8){
        const isRecord=g.score>=6;const stats=lang==='zh'?{['正确率']:g.score+'/'+g.total,['正确数']:g.score}:{Score:g.score+'/'+g.total,Correct:g.score};
